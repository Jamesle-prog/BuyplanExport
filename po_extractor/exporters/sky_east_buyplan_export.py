...
from ._sky_east_helpers import (
    ...
    _create_index_sheet, _create_overview_sheet, _fabric_version_note,
...
def export_sky_east_buyplan(
    ...
    # enriched this plan (version + date only -- these files go to clients/
    # factories, so internal detail like uploader/filename stays out).
    _create_index_sheet(tpl_wb, df_items, total_anchor=total_anchor,
                        ...
                        fabric_version_note=_fabric_version_note(fabric_version_id))
