...
_SEED: list[tuple[str, str, str, str]] = [
    ...
    ("Ask an administrator to change which brands are yours.",
     "如需调整所负责的品牌，请联系管理员。", "caption", "admin"),
    ("You don't have access to that brand.",
     "您无权访问该品牌。", "error", "admin"),
    ("Brand scope — 船样要求 (empty = all brands of their companies)",
     "品牌范围——船样要求（留空 = 其所属公司的全部品牌）", "label", "admin"),
    ("Who looks after which brand. A user with brands set sees and edits ONLY those brands' 船样要求 under 📐 Reference Data. Leave empty and they can edit every brand of the companies they are assigned to.",
     "指定各品牌的负责人。设置品牌后，该用户在「📐 参考数据」中仅能查看和编辑这些品牌的船样要求。留空则可编辑其所属公司的全部品牌。", "help", "admin"),
    ("Set brand scope",
     "设置品牌范围", "label", "admin"),
    ("Brand scope updated.",
     "品牌范围已更新。", "success", "admin"),
    ("e.g. M码齐色2套，S码齐色1套 (leave blank if none applies)",
     "例如：M码齐色2套，S码齐色1套（如无要求可留空）", "label", "admin"),
    ("with text",
     "项已填写", "label", "admin"),
    ...
    ('⬇️ Download Excel', '⬇️ 下载 Excel', 'label', 'admin'),
    ...
    ('Save Excel', '保存 Excel', 'button', 'giii'),
    ...
    ('Clear colour resolution log', '清空颜色解析日志', 'button', 'sky_east'),
    ...
    ('⬇️ Export fiber list (.xlsx)', '⬇️ 导出纤维列表 (.xlsx)', 'button', 'fabric_db'),
    ...
    ('Delete {n} record(s)', '删除 {n} 条记录', 'button', 'fabric_db'),
    ...
    ('⬇️ Download HHN orphans (.csv)', '⬇️ 下载孤立 HHN 编号 (.csv)', 'button', 'fabric_db'),
    ...
    ('⬇️ Download coverage gaps (.csv)', '⬇️ 下载覆盖缺口 (.csv)', 'button', 'fabric_db'),
    ...
    ('⬇️ Download errors (.xlsx)', '⬇️ 下载错误 (.xlsx)', 'button', 'fabric_db'),
    # Production tracking
