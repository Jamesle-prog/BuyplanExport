...
def get_ai_correction_store() -> AiCorrectionStore:
    """Return an AiCorrectionStore wired to the canonical DB."""
...
def get_factory_progress_store() -> FactoryProgressStore:
    """Return a fresh FactoryProgressStore wired to the canonical DB."""
...
def get_factory_registry_store() -> FactoryRegistryStore:
    """Return a fresh FactoryRegistryStore wired to the canonical DB."""
