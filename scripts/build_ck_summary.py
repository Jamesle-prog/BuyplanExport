"""Build CK HOL 26 PO Summary Excel in KL-reference format.

Parses every PDF in SUITS-CK / PO / HOL 26 ROSS, refreshes the production
...
OUT_PATH = r'C:\Users\Administrator\Desktop\CSKHHA_HOL26_PO_Summary.xlsx'

# Vendor prefix for this script — search recursively so files inside
# subfolders (e.g. an archive subfolder) are found automatically.
_VENDOR_PREFIX = 'cskhha'
